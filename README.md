...
## Normal item update cleanup

In the next exercise try to remove nested if statements in normalUpdate
...
* if less then 10 days quality increase by 2
* if less then 5 days quality increase by 3
